...
var <- c("cluster_walktrap", "Stage", "Population", "phase")
...
```{r, fig.height = 8, fig.width = 10}
var <- c("cluster_louvain", "Stage", "Population", "phase")
...
```{r, fig.height = 8, fig.width = 10}
var <- c("cluster_kmeans", "Stage", "Population", "phase")
...
```{r, fig.height = 8, fig.width = 10}
var <- c("cluster_hclust", "Stage", "Population", "phase")
