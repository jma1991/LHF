...
var <- c("Stage", "Population", "log10_total_counts", "log10_total_features_by_counts", "pct_counts_ERCC", "pct_counts_MT")
...
new <- computeSumFactors(new, min.mean = 1)
